...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <center>
        ...
        <div>
            <asp:Button ID="Button1" runat="server" Text="Cargar Contactos" OnClick="Button1_Click1"></asp:Button>
                <asp:Label ID="Label8" runat="server" Text=""></asp:Label>
            
        </div>         
        <div id="GrafoContactos">
            <div style="text-align:center; float:left; width:730px;">
                
                <asp:Image ID="Image11" runat="server" Height="700px" Width="725px" GenerateEmptyAlternateText="True" AlternateText="Imagen no disponible" />        
            </div>
