    ...
    public partial class ClienteInicio2 : System.Web.UI.Page
    {
        ...
        protected void Button5_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                String user = Application["usuario1"].ToString();
                string selectnivel = DropDownList1.SelectedItem.ToString();
                if (txtDestX.Text != "" && txtDestY.Text != "" && txtPosX.Text != "" && txtPosY.Text != "")
                {
                    if (tipo == 1)
                    {
                        if (servicio.getPiezasDestruidas(usuario2) && servicio.getPiezasDestruidas(user))
                        {
                        ...
                        else if (servicio.getPiezasDestruidas(usuario2) && !servicio.getPiezasDestruidas(user))
                        {
                            ...
                            String popupScript3 = "<script language='JavaScript'> alert('Ataques de " + user + ": " + ataques.ToString() + "\n Ataques de" + usuario2 + ":" + ataques2.ToString() + "'); </script>";
                            Page.RegisterStartupScript("PopupScript", popupScript3);


                            int contU = (int)Application["contU2"];
                            int contD = (int)Application["contD2"];
                            int contS = contU - contD;
                            servicio.insertarJuegos(usuario2, user, contU, contS, contD, true);
                    ...
                    else if (tipo == 2)
                    {
                        ...
                        else
                        {
                            ...
                            int usu1 = servicio.getContarP(usuario2);
                            int usu2 = servicio.getContarP(user);
                            if (usu1 > usu2)
                            {
                                String popupScript = "<script language='JavaScript'> alert('GANADOR" + usuario2 + "'); </script>";
                            ...
                            {
                                String popupScript = "<script language='JavaScript'> alert('GANADOR" + user + "'); </script>";
                                Page.RegisterStartupScript("PopupScript", popupScript);
                                int ataques = (int)Application["contAtack"];
                                int ataques2 = (int)Application["contAtack2"];
                                String popupScript3 = "<script language='JavaScript'> alert('Ataques de " + user + ": " + ataques.ToString() + "\n Ataques de" + usuario2 + ":" + ataques2.ToString() + "'); </script>";
                    ...
                    else
                    {
                        ...
                        {
                            String popupScript2 = "<script language='JavaScript'> alert('Han Capturado tu Base perdiste LA PARTIDA'); </script>";
                            Page.RegisterStartupScript("PopupScript", popupScript2);
                            int ataques = (int)Application["contAtack"];
                            int ataques2 = (int)Application["contAtack2"];
                            String popupScript3 = "<script language='JavaScript'> alert('Ataques de " + user + ": " + ataques.ToString() + "\n Ataques de" + usuario2 + ":" + ataques2.ToString() + "'); </script>";
                        ...
                        {
                            String popupScript2 = "<script language='JavaScript'> alert('Haz Capturado la Base Ganaste LA PARTIDA'); </script>";
                            Page.RegisterStartupScript("PopupScript", popupScript2);
                            int ataques = (int)Application["contAtack"];
                            int ataques2 = (int)Application["contAtack2"];
                            String popupScript3 = "<script language='JavaScript'> alert('Ataques de " + user + ": " + ataques.ToString() + "\n Ataques de" + usuario2 + ":" + ataques2.ToString() + "'); </script>";
                ...
                if (nickname == usuario2)
                {
                    ...
                    if (lvls != "")
                    {
                        ...
                        for (int j = 0; j < lvl.Length - 1; j++)
                        {
                            ...
                            if (danio > 0 && life > 0 && nickdes != usuario2)// SI  NO ENCUENTRA LAS PIEZAS DEVUELVE -1
                            {
                    ...
                    this.crearGrafo(servicio.grafoMatriz(1), "Matriz1cliente");
                    this.crearGrafo(servicio.grafoMatriz(2), "Matriz2cliente");
                    this.crearGrafo(servicio.grafoMatriz(3), "Matriz3cliente");
                    this.crearGrafo(servicio.grafoMatriz(4), "Matriz4cliente");
        ...
        private void AtaqueAlcance()
        {
            ...
            if ((ydes <= this.limitY) && (ydes > 0) && (posX2 < this.limitX) && (posX2 > 64))//para poder realizar el movimiento
            {
                ...
                if (resultadototal <= movimietno && resultadototal > 0 && nickname == usuario2)
                {
                    float danio = servicio.getDanio(x, y, nivel);
