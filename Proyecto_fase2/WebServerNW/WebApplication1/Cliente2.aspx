<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cliente2.aspx.cs" Inherits="WebApplication1.Cliente2" %>
...
<body>
    ...
    <div id="menu">
	<ul>
		<li><a href="Cliente.aspx">Inicio</a></li>
		<li><a href="#">TOP JUGADORES</a></li>
		<li><a href="Contactos2.aspx">Contactos</a></li>
...
<div id="page">
	...
	<div id="sidebar">
        ...
        <div style="text-align:right; float:right; width:200px;">Tiempo:
            ...
            <br/>
            <asp:Label ID="lblContador1" runat="server" Text=""></asp:Label>
            <br/>
            <asp:Label ID="lblContador2" runat="server" Text=""></asp:Label>
            <br/>
            <asp:Label ID="lblContador3" runat="server" Text=""></asp:Label>
            <br/>
            <asp:Label ID="lblContador4" runat="server" Text=""></asp:Label>
    ...
    <table style="width: 100%;">
        ...
        <tr>
            ...
            <td> 
                <br />
                <asp:Button ID="Button1" runat="server" Text="Iniciar Partida" OnClick="Button1_Click" />
                <br />
                <br />
            </td>
        ...
        <tr>
            ...
            <td> 
                <br />
                <asp:CheckBox ID="chkBase" runat="server" Text="Base(Solo si es de tipo base)"/>
                <br />
                <br />
            </td>
